      ...
      <div className="shadow-[rgb(100_100_111/12%)_0px_1px_4px_0px]">
        <div className="max-w-[1300px] mx-auto px-[20px]">
          <div className=" flex justify-between items-center lg:p-0 p-[20px_0]">
            <img
              className="xl:max-w-[80px] max-w-[60px]"
              src={Logo}
              alt="logo"
            />
            <div className="lg:flex hidden lg:gap-[24px] gap-[14px]">
              <a
                href="/"
              ...
              {/* <div className='p-[28px_0] group'>
                            <div className='xl:text-[16px] text-[14px] font-semibold text-[#3e337c] trans'>Product Features</div>
            ...
            <div className="flex xl:gap-[20px] gap-[12px] items-center">
              <button
                className="text-[24px] text-[#3e337c] trans"
                ...
                >
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-[360px] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="p-[14px]">
                      <div>
                        <p className="text-[#3e337c] text-center text-[14px] font-medium border-b-[#707070] border-b-[1px] pb-[14px]">
                          You have{" "}
                      ...
                      <div className="py-[30px] flex gap-[16px] items-start border-b-[#707070] border-b-[1px]">
                        <img
                          src={Fan}
                          alt="Fan"
                          className="w-[62px] rounded-md border border-gray-200"
                        />
                        <div>
                          <h5 className="text-[#3e337c] font-semibold text-[16px]">
                            Efficio Ceiling Fan
                          </h5>
                          <div className="mt-2">
                            <button className="items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800">
                              White
                            </button>
                            <button className="items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800 ml-[10px]">
                              1200mm
                            </button>
                          </div>
                          <div className="flex items-center gap-[12px] mt-[14px]">
                            ...
                            <div className="flex items-center">
                              <button
                                className="bg-[#3e337c] text-white w-[26px] h-[26px] flex justify-center items-center"
                                onClick={() => setCount(count - 1)}
                              >
                                -
                              </button>
                              <button className="flex justify-center items-center p-[2.5px_10px] text-[14px] text-[#3e337c] shadow-[0_2px_6px_1px_#3e337c30]">
                                {count}
                              </button>
                              <button
                                className="bg-[#3e337c] text-white w-[26px] h-[26px] flex justify-center items-center"
                            ...
                            <button className="text-[#000] text-[24px]">
                              <MdDelete />
                            </button>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <a
                          href="/checkout"
                          type="submit"
                          class="h-10 items-center justify-center font-semibold hover:underline w-full bg-[#E5E5E5] border border-transparent shadow-sm py-2 px-4 text-sm rounded-md text-black mt-[20px] flex"
                        >
                          Go to Checkout
                        </a>
                      </div>
              ...
              <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                >
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg p-[20px]">
                    <div>
                      <h3 className="text-[#3e337c] font-bold text-center text-[28px]">
                        Log Out
                      </h3>
                      <p className="text-[#3e337c] text-[16px] text-center font-medium mt-3">
                        Are you sure you want to log out?
                      </p>
                      <div class="flex gap-[20px] mt-[40px] sm:flex-nowrap flex-wrap justify-center">
                        <button
                          onClick={() => setOpen(false)}
                          class="bg-[#c6c0db] text-[#f8f6ff] rounded-lg sm:w-[120px] p-[10px_20px] uppercase font-semibold"
                        >
                          Cancel
                        </button>
                        <a
                          href="/login"
                          class="bg-[#3e337c] text-[#f8f6ff] rounded-lg sm:w-[120px] text-center p-[10px_20px] uppercase font-semibold"
                        >
                          OK
                        </a>
                      </div>
            ...
            <div className="max-w-[1200px] mx-auto">
              <div className="relative">
                <input
                  ...
                  className="text-[14px] w-full border-[#c6c0db] text-[#3e337c] font-medium border-[1px] rounded-md p-[8px_12px] outline-none"
                />
                <button
                  className="absolute right-[8px] top-[50%] translate-y-[-50%] text-[#3e337c]"
