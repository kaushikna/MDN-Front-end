...
const community = [
    ...
    {
        name: '1 million happy homes with Atomberg fans.',
    }
]
            ...
            <div>
                ...
                <div className='bg-[#f8f6ff]'>
                    <div className='max-w-[1300px] mx-auto px-[20px]'>
                        <div className='grid sm:grid-cols-2 gap-[30px] p-[50px_0]'>
                            <div>
                                <p className='text-[#3e337c] font-medium sm:text-[16px] text-[14px] mb-[24px] leading-[28px] '>Atomberg is in the business of revolutionizing India's home appliances, by solving one problem at a time.</p>
                ...
                <div className='bg-[#f1edff] rounded-[0_0_50px_50px] lg:pb-[100px] pb-[70px]'>
                    <div className='max-w-[1300px] mx-auto px-[20px]'>
                        <div className='grid sm:grid-cols-2 gap-[30px] p-[50px_0]'>
                            <div>
                                <p className='text-[#3e337c] font-medium sm:text-[16px] text-[14px] mb-[24px] leading-[28px] '>Atomberg Technologies origin story begins with two IIT-Bombay graduates:Manoj Meena and Sibabrata Das, and some serious hi-tech.</p>
