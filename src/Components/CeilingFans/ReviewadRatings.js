        ...
        <div className=' bg-[#a9a4ba] py-[60px] review-main'>
            <div className="max-w-[1300px] mx-auto px-[20px]">
                <div>
                    ...
                    <p className='text-[#3e337c] text-[14px] mt-[20px] text-center max-w-[800px] mx-auto'>More than 90% of our customers who have bought Atomberg products have loved them. Do take a look at what some of them have to say:</p>
