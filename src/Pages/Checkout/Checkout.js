                    ...
                    <div className='md:flex items-start xl:gap-[40px] gap-[20px]'>
                        <div className='md:w-[60%] w-full '>
                            <div className='bg-[#7b7492] sm:p-[20px] p-[20px_12px] rounded-xl pb-[40px]'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-2 mt-[30px]'>
                                        ...
                                        <label for='check' className='text-[#fff] text-[14px] font-normal select-none cursor-pointer'>By clicking this you allow communication from MDN technologies</label>
                                    </div>
                            ...
                            <div className='flex items-center gap-2 mt-[20px]'>
                                ...
                                <label for='check1' className='text-[#3e337c] text-[14px] font-medium select-none cursor-pointer'>By clicking this you allow communication from MDN technologies</label>
                            </div>
                            <div className='bg-[#7b7492] sm:p-[20px] p-[20px_12px] rounded-xl mt-[20px]'>
                                ...
                                <div className='flex items-center gap-2 mt-[20px]'>
                                    ...
                                    <label for='check3' className='text-[#fff] text-[14px] font-normal select-none cursor-pointer'>By clicking this you allow communication from MDN technologies</label>
                                </div>
                            </div>
