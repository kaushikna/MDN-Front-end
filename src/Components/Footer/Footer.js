                ...
                <div className='max-w-[1300px] mx-auto p-[60px_16px] text-[#3e337c] w-full'>
                    <div className='xl:flex-row flex-col flex gap-[40px]'>
                        <div className='xl:max-w-[390px]'>
                            ...
                            <p className='lg:text-[14px] text-[12px] max-w-[400px] mt-[20px]'>MDN electronics  manufacturing of smart and energy-efficient home appliances powered by the BLDC motor.</p>
                            <p className='lg:text-[14px] text-[12px] mt-4'>Name of Company:- <span className='font-semibold'>MDN electronics PRIVATE LIMITED</span></p>
                            <p className='text-[12px] mt-1'>Address of its registered office:-</p>
                            <p className='lg:text-[14px] text-[12px] italic font-semibold mt-1'>Office No. 181, Hinglaj Tempal, Singrava Kathavada Road, Daskori, Ahmedabad- 380014</p>
                            ...
                            <p className='lg:text-[14px] text-[12px] mt-4'>Telephone Number:- <span className='font-semibold'>84011 85849</span></p>
                        ...
                        <div className='grid md:grid-cols-4 sm:grid-cols-2 lg:gap-[40px] md:gap-0 gap-[30px]'>
                            ...
                            <div>
                                ...
                                <ul className='flex flex-col gap-1'>
                                    ...
                                    <li><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>Gas Stove</a></li>
                                    <li><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>Electronic Gizer</a></li>
                            ...
                            <div className='sm:max-w-[250px]'>
                                ...
                                <ul>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>For expert help and customer complaints, call: 8401085849</a></li>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>Timings: 9 am to 9 pm on all days except public holidays</a></li>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>Whatsapp: 840-108-5849</a></li>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>Email: mdneletronics@gmail.com</a></li>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>For sales assistance & partnership:mdneletronics@gmail.com</a></li>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>For after sales support (Service complaint registration): mdneletronics@gmail.com</a></li>
                                    <li className='mb-3'><a href='#' className='lg:text-[14px] text-[12px] hover:underline'>For all other queries: mdneletronics@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
